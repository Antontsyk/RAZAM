...
var exampleApp = angular.module('razam', ['ionic', 'angularMoment', 'razam.controllers', 'razam.directives', 'razam.filters', 'razam.services', 'razam.factories', 'underscore','ngResource', 'ngCordova', 'templates', 'slugifier','naif.base64','ngImgCrop'])
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('app', {
    ...
    .state('app.messageresult', {
    url: "/messageresult",
    views: {
      'menuContent': {
        templateUrl: "templates/messageresult.html",
        controller: 'MessageResultCtrl'
      }
    },
    data: {
      // authenticate: true
